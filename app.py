...
if menu == "Inicio":
    ...
    if st.button("💾 GUARDAR ENTREVISTA AHORA EN GOOGLE SHEETS", key=f"{prefix}_guardar_google_sheets_visible", type="primary", use_container_width=True):
        try:
            guardar_en_google_sheets_directo(datos)
        except NameError:
            st.error("No se encontró el diccionario datos en este formulario. Avise a William para revisar la sección.")
        except Exception as e:
