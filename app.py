...
NOTEBOOKLM_URL = os.environ.get("NOTEBOOKLM_URL", "https://notebooklm.google.com/notebook/d2b6062f-11e1-4933-844a-487061d61785?authuser=1").strip()
...
if not st.session_state.logueado:
    ...
    st.info("Credenciales: admin / admin123  |  usuario / usuario123")
    st.stop()
